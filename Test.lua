...
counter.Position = UDim2.new(0,5,0,50)
...
startBtn.Position = UDim2.new(0,5,0,80)
...
fpsBtn.Position = UDim2.new(0,5,0,115)
...
local currentStatus = CONFIG.autoStart and "Farming" or "Idle"
